...
def export_turtle(ontology: OntologyEngine | None = None,
    ...
    domain_hints = {
        ...
        "ExportControlledAsset": "RegulatoryCompliance",
        "ItarAsset": "RegulatoryCompliance",
        "EarAsset": "RegulatoryCompliance",
        "NrcRegulatedAsset": "RegulatoryCompliance",
        "DoeRegulatedAsset": "RegulatoryCompliance",
